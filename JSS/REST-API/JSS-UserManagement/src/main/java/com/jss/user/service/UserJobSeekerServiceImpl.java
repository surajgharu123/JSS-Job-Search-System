...
public class UserJobSeekerServiceImpl implements UserJobSeekerService{
	...
	private UserJobSeekerDTO convertEntityintoDTO(UserJobSeekerEntity userJobEntity) {
		TypeMap<UserJobSeekerEntity,UserJobSeekerDTO> typemap=modelMapper.typeMap(UserJobSeekerEntity.class, UserJobSeekerDTO.class);
...
private UserJobSeekerEntity convertDTOintoEntity(UserJobSeekerDTO userJobDTO) {
		...
		TypeMap<UserJobSeekerDTO,UserJobSeekerEntity> typemap=modelMapper.typeMap(UserJobSeekerDTO.class, UserJobSeekerEntity.class);
		typemap.addMappings(mapper->{
